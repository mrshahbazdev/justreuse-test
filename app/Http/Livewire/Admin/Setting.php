...
class Setting extends Model
{
	...
	public static function htmlAdBlock($post_id)
	{
		...
		$html .= '</h3>
					...
					<a class="block" href="' . $slug . '">
						...
						<img alt="' . $post_title . '" data-src="' . $imgUrlfinal . '" src="' . $imgUrlfinal . '" width="400" height="400" class="transform hover:scale-125 transition duration-500 ease-in-out m-auto max-h-full object-cover h-screen w-screen w-full" loading="lazy">
		...
		if ($dir == "false") {
			$html .= '<p class="mb-2 sm:mt-0.5 sm:my-2 text-base w-full inline-block"><span class="block text-green-500 poppins-600  border-l-0 border-r-0 text:xl md:text:lg lg:text-lg py-0.5 ' . $linethrough . '">' . $currency . '&nbsp;' . $post_price . '&nbsp;' .   $currency_code[0] . '</span>';
			// $html .= '<p class="mb-2 sm:mt-0.5 sm:my-2 text-base w-full inline-block"><span class="block text-green-500 poppins-600  border-l-0 border-r-0 text:xl md:text:lg lg:text-lg py-0.5 ' . $linethrough . '">' . $current_currency_symbol . '&nbsp;' . $post_price . '&nbsp;' .   $current_currency_code . '</span>';
			if (intval($userPerferCurrency) != intval($default_currency)) {
	...
	public static function SliderBlock($post_id)
	{
		...
		$html .= '</h3>
					...
					<a class="block" href="' . $slug . '">
						<div class="flex items-center justify-center h-48 md:h-60 product_inner_image">
						<img alt="' . $post_title . '" data-src="' . $imgUrlfinal . '" src="' . $imgUrlfinal . '" width="400" height="400" class="transform hover:scale-125 transition duration-500 ease-in-out m-auto max-h-full object-cover h-screen w-screen w-full">
						<!--img alt="' . $post_title . '" src="' . $imgUrlfinal . '" class="w-full transform hover:scale-125 transition duration-500 ease-in-out h-80 w-80 object-cover object-center"-->
						</div>
					</a>
				</div>
