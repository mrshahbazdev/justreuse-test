...
! function(e) {
    ...
    ! function(e) {
        ...
        var s = function(e, t) {
                void 0 === t && (t = !1);
                var r = [null, void 0, ""];
                for (var n in t && r.push(!1), e) r.includes(e[n]) ? delete e[n] : Array.isArray(e[n]) && (e[n].length || delete e[n]);
                return e
            },
            u = function(e) {
            ...
            A = function(e) {
                var t = [];
                if (e.length)
                    for (var r = e[0].getElementsByTagName("value"), n = 0; n < r.length; n++) t.push(r[n].textContent);
                return t
            },
            O = function(e) {
        ...
        var Q = {
            ...
            merge: function e(t, r) {
                ...
                for (var o in r) n.hasOwnProperty(o) && (Array.isArray(r[o]) ? n[o] = Array.isArray(t[o]) ? E(t[o].concat(r[o])) : r[o] : "object" == typeof r[o] ? n[o] = e(t[o], r[o]) : n[o] = r[o]);
                return n
            },
            mobileClass: F,
            nameAttr: g,
        ...
        var u = function() {
            ...
            e.register = function(t, r, n) {
                ...
                for (var i, l = a(t); !(i = l()).done;) {
                    var s = i.value; - 1 === s.indexOf(".") ? e.classRegister[o + s] = r : e.error("Ignoring type " + s + ". Cannot use the character '.' in a type name.")
                }
        ...
        var i = {
                ...
                allowStageSort: !0,
                append: !1,
                controlOrder: ["select", "radio-group", "checkbox", "checkbox-group", "number", "date", "button", "header", "hidden", "paragraph", "autocomplete", "text", "textarea", "file"],
                controlPosition: "right",
                dataType: "json",
                defaultFields: [],
                disabledActionButtons: ['clear', 'data', 'save'],
                disabledAttrs: ["access", "description", "placeholder"],
                ...
                disabledSubtypes: {},
                disableFields: ["date", "autocomplete", "file", "button", "header", "hidden", "paragraph"],
                disableHTMLLabels: !1,
        ...
        var w = function() {
                ...
                return r.startMoving = function(e, t) {
                    ...
                    if (r) f.classList.add("positioned");
                    else {
                ...
                return t.init = function() {
                    ...
                    for (var i = 0; i < r.length; i++) {
                        var a = r[i],
                            ...
                            s = void 0;
                        if (l) s = l.class;
                        else if (l = {}, !(s = b.a.getClass(a)) || !s.active(a)) continue;
        ...
        var C = function(e, t, r) {
                ...
                var T = function(t, n) {
                    ...
                    D = function(t) {
                        ...
                        (t = v.getData(t)) && t.length ? (t.forEach((function(e) {
                            ...
                            return T(e)
                        })), h.stage.classList.remove("empty")) : e.prepend || e.append || (h.stage.classList.add("empty"), h.stage.dataset.content = c.a.get("getStarted")), n = [], o = function(t) {
                            return y("li", e[t], {
                ...
                if (C.on("change", [".prev-holder input", ".prev-holder select", ".prev-holder textarea"].join(", "), (function(e) {
                        ...
                        if (!confirm('Do you really wan to remove?')) {
                            return false;
                        }
                        t.preventDefault();
                ...
                return document.dispatchEvent(f.a.loaded), o.actions = {
                    ...
                    toggleFieldEdit: function(e) {
                        (Array.isArray(e) ? e : [e]).forEach((function(e) {
                            ["number", "string"].includes(typeof e) && ("number" == typeof e ? e = h.stage.children[e].id : /^frmb-/.test(e) || (e = h.stage.querySelector(e).id), v.toggleEdit(e))
                        }))
                    },
