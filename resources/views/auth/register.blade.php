        ...
        <div class="flex w-full max-w-4xl bg-white rounded-2xl shadow-2xl">
            ...
            <div class="hidden md:flex flex-col justify-center w-1/2 p-12 bg-cover bg-center text-white" style="background-image: url('https://images.unsplash.com/photo-15329996398na7-b0038b056156?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3');">
                <div class="bg-opacity-50 p-8 rounded-lg backdrop-blur-sm" style="background: #F5F5F5;">
                    <img src="{{ !empty($settings['logo']) ? asset('storage/' . $settings['logo']) : 'https://justreused.com/assets/images/logo.png' }}" alt="JustReused Logo" class="w-54 mb-4">
            ...
            <div class="w-full md:w-1/2 p-8 sm:p-12">
                ...
                <div class="text-center mb-6">
                    <img src="{{ !empty($settings['logo']) ? asset('storage/' . $settings['logo']) : 'https://justreused.com/assets/images/logo.png' }}" alt="JustReused Logo" class="w-54 mx-auto mb-4 md:hidden">
                ...
                <div class="text-white px-4 py-3 border-0 rounded relative mb-4 bg-red-500 alert-danger">
                    <span class="inline-block align-middle mr-8">{{ Session::get( 'error' ) }}</span>
                ...
                <div class="mt-4 animate-fadeInUp" style="animation-delay: 1.1s;">
                    ...
                    <div class="flex justify-center space-x-4">
                        <a href="{{ URL::to('/auth/google') }}" class="social-icon-hover flex items-center justify-center w-12 h-12 text-xl text-gray-600 bg-gray-100 border border-gray-200 rounded-full transition transform hover:scale-110"><i class="fab fa-google"></i></a>
                        <a href="{{ URL::to('auth/facebook') }}" class="social-icon-hover flex items-center justify-center w-12 h-12 text-xl text-gray-600 bg-gray-100 border border-gray-200 rounded-full transition transform hover:scale-110"><i class="fab fa-facebook-f"></i></a>
                    </div>
                </div>

                <p class="mt-6 text-center text-gray-600 animate-fadeInUp" style="animation-delay: 1.2s;">
                    {{ __('messages.already registered') }}? <a href="{{ route('login') }}" class="font-bold text-green-600 hover:text-green-700 hover:underline">{{ __('messages.sign in') }}</a>
                </p>
