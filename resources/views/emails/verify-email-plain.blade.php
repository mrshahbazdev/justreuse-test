                ...
                <table class="container" border="0" cellpadding="0" cellspacing="0" style="width: 100%; max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 8px; box-shadow: 0 4px 15px rgba(0,0,0,0.05);">
                    ...
                    <tr>
                        <td class="header" style="background-color: #39763a; padding: 30px 20px; text-align: center; border-radius: 8px 8px 0 0;">
                            <img src="{{ asset('storage/' . \App\Models\Setting::get_logos()['logo']) }}" alt="JustReused Logo" width="150" style="display: block; margin: auto; border:0;">
                    ...
                    <tr>
                        <td class="content" style="padding: 40px;">
                            <h2 style="color: #333333; font-size: 22px; margin-top: 0;">Almost there, {{ $user->name }}!</h2>
                            ...
                            <table width="100%" border="0" cellpadding="0" cellspacing="0" style="margin: 30px 0;">
                                <tr>
                                    <td align="center">
                                        <a href="{{ $url }}" target="_blank" class="button" style="background-color: #f8991b; color: #ffffff !important; padding: 15px 30px; text-decoration: none; border-radius: 5px; font-weight: bold; display: inline-block; font-size: 16px;">Verify Email Address</a>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <p style="font-size: 12px; color: #39763a; word-break: break-all;"><a href="{{ $url }}" style="color: #39763a;">{{ $url }}</a></p>
