...
<div class="w-full forest-bg-green flex flex-col" {{$class_dir}}>
	<div class="container px-4 mx-auto md:flex md:flex-row">
			...
			<div class="py-2 pt-6 md:pt-10 md:w-4/12">
				<div class="footer_logo_section w-full lg:w-3/4">
					<div class="footer_logo text-center md:text-left">
						<img class="inline-block w-48 lg:w-min h-16 object-contain p-2" src="{{URL::to('storage/'.$settings['logo'])}}" alt="logo">
					</div>
					<?php
					if (!empty($post_methods)) {
						$check_banner_ads = $post_methods->pluck('name')->toArray();
						if (in_array("bannerads", $check_banner_ads)) { ?>
							<a class="banner_adv text-white px-2  focus:outline-none rounded py-2 btn-gradiant  rounded-sm mt-8 w-full  ease-linear transition-all duration-500" href="{{ URL::to('/pages/banner-ads') }}">
								{{__('messages.banner advertise')}}
							</a>
					<?php }
					} ?>
					<ul class="w-full mt-8 text-center md:text-left">
						<li class="inline-block px-3 lg:pr-10 lg:pl-0"><a href="#" aria-label="Facebook" class="text-base font-semibold text-white"></a><a href="https://www.facebook.com/" target="_blank"><img src="{{ URL::to('images/frontend/fb.webp') }}" alt="facebook"></a></li>
						<li class="inline-block px-3 lg:pr-10 lg:pl-0"><a href="#" aria-label="Instagram" class="text-base font-semibold text-white"></a><a href="https://www.instagram.com/" target="_blank"><img src="{{ URL::to('images/frontend/insta.webp') }}" alt="instagram"></a></li>
						<li class="inline-block px-3 lg:pr-10 lg:pl-0"><a href="#" aria-label="Twitter" class="text-base font-semibold text-white"></a><a href="https://www.twitter.com/" target="_blank"><img src="{{ URL::to('images/frontend/twitter.webp') }}" alt="twitter"></a></li>
					</ul>
				</div>
			</div>
			<!--End EN Alignment-->
			...
			<div class="py-2 pt-6 md:pt-10 md:w-4/12">
				<div class="footer_logo_section w-full lg:w-3/4">
					<div class="footer_logo text-center md:text-right">
						<img class="inline-block w-48 lg:w-min" src="{{URL::to('storage/'.$settings['logo'])}}" alt="logo">
					</div>
					<?php
					if (!empty($post_methods)) {
						$check_banner_ads = $post_methods->pluck('name')->toArray();
						if (in_array("bannerads", $check_banner_ads)) { ?>
							<a href="{{ URL::to('/pages/banner-ads') }}" class="block w-full">
					...
					<ul class="w-full mt-8 text-center md:text-right">
						<li class="inline-block px-3 lg:pl-10 lg:pr-0"><a href="#" aria-label="Facebook" class="text-base font-semibold text-white"></a><a href="https://www.facebook.com/" target="_blank"><img src="{{ URL::to('images/frontend/fb.png') }}" alt="facebook"></a></li>
						<li class="inline-block px-3 lg:pl-10 lg:pr-0"><a href="#" aria-label="Instagram" class="text-base font-semibold text-white"></a><a href="https://www.instagram.com/" target="_blank"><img src="{{ URL::to('images/frontend/insta.png') }}" alt="instagram"></a></li>
						<li class="inline-block px-3 lg:pl-10 lg:pr-0"><a href="#" aria-label="Twitter" class="text-base font-semibold text-white"></a><a href="https://www.twitter.com/" target="_blank"><img src="{{ URL::to('images/frontend/twitter.png') }}" alt="twitter"></a></li>
					</ul>
				</div>
			</div>
			<!--END AR Alignment-->
		...
		<div class="py-2 pt-6 md:pt-10 md:w-3/12">
			...
			@if(!empty($get_country))
			<ul>
				@foreach($pop_locations as $key=>$pop_location)
				<?php
...
<!-- <script src="{{ URL::to('js/allmin.js') }}"></script> -->
...
<!-- <script>
	$(document).ready(function() {
		setTimeout(function() {
			$('footer').append('<script async src="{{ URL::to('js/slick.min.js') }}"><\/script>')
		}, 3000);
	});
</script> -->
<!-- <script src="{{ URL::to('js/stimulus.umd.js') }}"></script> -->
<!-- <script src="{{ URL::to('js/tailwind_popper.js') }}" defer></script> -->
<!-- <script src="{{ URL::to('js/lazysizes.min.js') }}"></script> -->
<script>
    setTimeout(function() {
        var script = document.createElement('script');
        script.src = "{{ URL::to('js/lazysizes.min.js') }}";
        document.body.appendChild(script);
    }, 3000); // 5000ms = 5 seconds
</script>
<script src="{{ URL::to('js/lazyload_js_css.js') }}"></script>
