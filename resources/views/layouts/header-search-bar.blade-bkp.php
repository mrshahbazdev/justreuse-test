	...
	if($dir_rtl =="false"){  ?>
	<div class="search_prod_loc search-field-open absolute top-full z-10 lg:relative lg:top-auto bg-white w-full lg:w-2/5 xl:w-1/2 float-left hidden lg:block p-3 sm:p-5 lg:p-0 shadow lg:shadow-none">
		...
		<script>
			...
			document.getElementById("search").addEventListener("click", function() {
				...
				if ((document.getElementById("location").value) != "") {
					...
					result = path + "/" + current_address + "?country=" + country + "&loc=" + location + "&d=5";
				}
				//result = path + "/" + current_address + "?c=" + c + "&s=" + term + "&locality=" + locality + "&city=" + city + "&state=" + state + "&country=" + country + "&lat=" + latitude + "&lng=" + longitude + "&loc=" + location + "&d=5";
				//alert(result);
