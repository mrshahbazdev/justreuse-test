                                ...
                                <div class="max-h-80 overflow-y-auto">
                                    @forelse($dropdownConversations as $convo)
                                        ...
                                        <button 
                                            ...
                                            <img class="h-10 w-10 rounded-full object-cover mr-3" src="{{ $convo['sender']->profile_photo_path ? asset('storage/' . $convo['sender']->profile_photo_path) : 'https://placehold.co/40x40' }}" alt="Avatar">
                                            <div class="flex-grow">
