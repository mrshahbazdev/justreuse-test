        ...
        <div class="bg-white rounded-lg overflow-hidden shadow-xl transform transition-all sm:max-w-lg sm:w-full">
            <form wire:submit.prevent="store">
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6">
                    <h3 class="text-lg leading-6 font-medium text-gray-900">{{ $zone_id ? 'Edit' : 'Create' }} Ad Zone</h3>
                        ...
                        <div>
                         ...
                         <div>
                            ...
                            <input type="text" wire:model.defer="page_location" id="page_location" placeholder="e.g., home, search, post_detail" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                             @error('page_location') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                        </div>
                        <div>
