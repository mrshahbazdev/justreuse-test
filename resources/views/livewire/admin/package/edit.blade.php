		...
		<div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-5">
			...
			<div class="bg-gray-50 px-4 pt-5 pb-4 sm:p-6 sm:pb-4 text-left border rounded shadow mt-4">
                <div class="flex flex-col mb-4 md:w-full">
                    <h1 class="text-2xl font-medium text-gray-900 mb-3">Edit Package</h1>
                ...
                <?php if ($this->lft != 1) { ?>
                    <div class="flex flex-col mb-4 md:w-full">
                        ...
                        <?php } else { ?>
                            <input type="text" placeholder="Price" disabled readonly="true" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                    ...
                    <div class="mb-4">
                        ...
                        <ul class="flex flex-wrap content-start">
                            ...
                            <label class="inline-flex items-center">
                                <input wire:model="ad_type" type="radio" class="form-radio" value="{{$key}}" <?php if ($this->ad_type == $key) {
                                                                                                                    echo "checked";
                                                                                                                } ?>>
                    ...
                    <div class="mb-4">
                        ...
                        <ul class="flex flex-wrap">
                            <label class="inline-flex items-center">
                                <input wire:model="bulk_type" type="radio" class="form-radio" value="1" <?php if ($this->bulk_type == 1) {
                                                                                                            echo "checked";
                                                                                                        } ?>>
                                <span class="ml-2 mr-1">Based on Package</span>
                            </label>
                            <label class="inline-flex items-center">
                                <input wire:model="bulk_type" type="radio" class="form-radio" value="2" <?php if ($this->bulk_type == 2) {
                                                                                                            echo "checked";
                                                                                                        } ?>>
                    ...
                    <div class="bulk-limit flex flex-col mb-4 md:w-full">
                        <label class="block text-gray-700 text-sm font-bold mb-2">Bulk Ad Limit</label>
                        <input type="number" wire:model="bulk_limit" min="1" step="1" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                ...
                <?php if ($this->lft == 1) { ?>
                    <div class="flex flex-col mb-4 md:w-full">
                        ...
                        <?php if (!empty($currency_symbol)) { ?>
                            <div class="inline-flex">
                                <span class="p-2 border shadow mr-2"><?php echo $currency_symbol['currency_hex'];; ?></span>
                                <input type="text" wire:model="price" placeholder="Price" disabled="true" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                            </div>
                        <?php } else { ?>
                            <input type="text" placeholder="Price" disabled="true" readonly="true" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                            <p class="bg-red-300 text-xs p-1 rounded mt-4 mb-4">Note :: Before update the price please set the default currency in the application settings.</p>
                        <?php } ?>
                        @error('price') <span class="text-red-500">{{ $message }}</span>@enderror
                    </div>
                    <div class="flex flex-col mb-4 md:w-full">
                        <label class="block text-gray-700 text-sm font-bold mb-2">Ad Limit</label>
                        <input type="number" wire:model="single_pack_limit" min="1" step="1" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                        @error('single_pack_limit') <span class="text-red-500">{{ $message }}</span>@enderror
                    </div>
                <?php } ?>
