<div>
    <div class="py-2">
        ...
        <button wire:click="back()" class="bg-green-500 hover:bg-orange-500 text-white text-xs  py-2 px-4 rounded-sm my-3">Back</button>
		</div>
            <div class="bg-gray-50 px-4 pt-5 pb-4 sm:p-6 sm:pb-4 text-left border rounded shadow mt-4">
            <h1 class="text-2xl font-medium text-gray-900">Create New Report</h1>
