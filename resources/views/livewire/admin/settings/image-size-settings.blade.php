        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-5 top-shadow">
            ...
            <div class="bg-white px-0 xl:px-4 pt-5 pb-4 sm:p-2 sm:pb-4 text-left">
                ...
                <div class="flex flex-col mb-4 w-1/2">
                    ...
                    @error('list_page') <span class="text-red-500">{{ $message }}</span>@enderror
                </div>
                <div class="flex flex-col mb-4 md:w-1/2">
                    ...
                    @error('detail_page') <span class="text-red-500">{{ $message }}</span>@enderror
                </div>
                <div class="flex flex-col mb-4 md:w-1/2">
                    ...
                    @error('max_image_limit') <span class="text-red-500">{{ $message }}</span>@enderror
                </div>
                <div class="p-2">
