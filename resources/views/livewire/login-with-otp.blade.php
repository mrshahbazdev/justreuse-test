			...
			<div class="bg-white w-full rounded-xl mb-2">
				<div class="py-6 sm:py-10 lg:py-16 mx-4 sm:mx-10 flex-auto">
					  ...
					  <div class="relative w-full mb-3">
						<input type="text" id="phone" name="phone" value="" class="rounded shadow-sm w-full border bg-gray-200 border-gray-200 placeholder-gray-500 text-gray-500 px-3 py-4 pl-6 sm:pl-10 sm:rounded-xl outline-none focus:outline-none" placeholder="{{__('messages.phone')}}">
						<input type="hidden" id="is-otp-sent" />
					  </div>
					  <div class="relative w-full mb-3 mt-4 otp-visible">
						<input type="text" autocomplete="off" id="otp" name="otp" class="w-2/4 border bg-gray-200 border-gray-200 px-3 py-3 sm:py-4 pl-6 sm:pl-10  bg-transparent rounded sm:rounded-xl text-gray-500 text-sm outline-none focus:outline-none focus:ring w-full" placeholder="{{__('messages.OTP')}}">
					  </div>
					  <input type="button" class="cursor-pointer resend-otp text-center text-lg text-gray-500 font-semibold no-underline bg-transparent mt-2" value="{{__('messages.resend otp')}}" />
					  <div class="text-center mt-4 sm:mt-7">
						<input type="button" value="{{__('messages.send otp')}}" class="sendotp text-white px-2 py-2 pb-3 sm:py-3 sm:pb-4 bg-green-500 rounded sm:rounded-xl text-sm sm:text-base md:text-lg font-bold focus:outline-none hover:bg-white hover:text-green-500 border-2 border-green-500 w-full cursor-pointer ease-linear transition-all duration-150" />
					  </div>
				</div>
			</div>
		</div>
