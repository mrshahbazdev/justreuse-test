<div>
   <div class="bg-white text-left" >
              <div class="mb-4">
                <h1 class="text-lg font-medium text-gray-900">{{__('p_profile.update user profile')}}</h1>
                  <label class="block text-gray-700 text-sm font-bold mb-2">{{__('p_profile.first name')}}:</label>
              ...
              <div class="mb-4">
                  <label class="block text-gray-700 text-sm font-bold mb-2">{{__('p_profile.last name')}}:</label>
              ...
              <div class="mb-4">
                  <label class="block text-gray-700 text-sm font-bold mb-2">{{__('p_profile.address line')}} 1:</label>
              ...
              <div class="mb-4">
                  <label class="block text-gray-700 text-sm font-bold mb-2">{{__('p_profile.address line')}} 2:</label>
              ...
              <div class="mb-4">
                  <label class="block text-gray-700 text-sm font-bold mb-2">{{__('p_profile.phone')}}:</label>
              ...
              <div class="mb-4">
                  <label class="block text-gray-700 text-sm font-bold mb-2">{{__('p_profile.date of birth')}}:</label>
              ...
              <div class="mb-4">
                  <label class="block text-gray-700 text-sm font-bold mb-2">{{__('p_profile.gender')}}:</label>
      ...
      <div class="justify-center bg-gray-50 px-4 sm:px-6 sm:flex sm:flex-row-reverse">
