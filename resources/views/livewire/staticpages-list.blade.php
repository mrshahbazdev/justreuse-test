	...
	<div class="w-full float-left common_page_style">
		<div class="w-full float-left my-3 sm:mt-6 sm:mb-4">
			<div class="container mx-auto px-4">
				<h1 class="text-xl md:text-2xl font-bold text-black uppercase">{{$list->title}}</h1>
			</div>
		</div>
	...
	<div class="text-center p-12">
		<div class="p-8">
			<div class="text-2xl pb-8"><p class="text-base font-bold">{{__('messages.page not found')}}!</p></div>
		</div>
	</div>
	<?php } ?>
	</div>