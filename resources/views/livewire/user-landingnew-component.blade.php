	          ...
	          <div class="bg-white rounded-2xl border border-slate-200 smooth-shadow">
	            <div class="flex flex-col md:flex-row">
	              ...
	              <div class="flex-1 flex items-center gap-3 px-4 py-3">
	                ...
	                <input id="loc" type="text" placeholder="Location" class="w-full bg-transparent text-slate-800 placeholder-slate-400 focus:outline-none text-base">
	              ...
	              <button class="md:w-auto w-full bg-primary text-white px-6 py-3 font-bold rounded-b-2xl md:rounded-bl-none md:rounded-r-2xl hover:bg-primary-dark transition">
	                Search
	              </button>
	            </div>
	    ...
	    <section class="py-14">
	      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
	        <div class="text-center reveal">
	          ...
	          <p class="mt-2 text-slate-600">Find what you need, .</p>
	        </div>
	          ...
	          <div class="swiper category-swiper">
	            ...
	            @foreach($main_categories as $main_category)
					<?php
						...
						//dd($cat_img);
					?>
	              <a href="#" class="swiper-slide reveal lift rounded-xl border border-slate-200 bg-white p-5 text-center hover:border-primary">
	                <div class="mx-auto mb-3 flex h-14 w-14 items-center justify-center rounded-full bg-primary/10 text-primary"><i class="fa-solid fa-car text-2xl"></i></div>
	    ...
	    <section class="py-14 bg-white relative overflow-hidden">
	      ...
	      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative">
	        <div class="text-center reveal">
	          ...
	          <div id="tabs" class="mt-6 inline-flex gap-2 rounded-full bg-slate-100 p-1">
	            <button class="tab-btn font-semibold px-4 py-2 rounded-full text-slate-600 data-[active=true]:bg-white data-[active=true]:shadow data-[active=true]:text-slate-900 transition-colors"
	                    data-tab="featured" data-active="true">Featured</button>
	            <button class="tab-btn font-semibold px-4 py-2 rounded-full text-slate-600 data-[active=true]:bg-white data-[active=true]:shadow data-[active=true]:text-slate-900 transition-colors"
	                    data-tab="popular" data-active="false">Popular</button>
	            <button class="tab-btn font-semibold px-4 py-2 rounded-full text-slate-600 data-[active=true]:bg-white data-[active=true]:shadow data-[active=true]:text-slate-900 transition-colors"
	        ...
	        <div id="tab-content" class="mt-10">
	          ...
	          <div id="featured" class="tab-pane grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6"></div>
	          <div id="popular" class="tab-pane hidden grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6"></div>
	          <div id="latest" class="tab-pane hidden grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6"></div>
	        </div>
	      </div>
	    </section>
