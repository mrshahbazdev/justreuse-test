        ...
        <tr><td align="center" style="padding: 20px 0;">
            <table style="width: 100%; max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 8px;">
                ...
                <tr><td style="padding: 40px;">
                    <h2 style="color: #333; font-size: 22px; margin-top: 0;">Hello <?php echo e($user->name); ?>,</h2>
...
<?php /**PATH /home/justreused/htdocs/www.justreused.com/resources/views/emails/password-reset-otp.blade.php ENDPATH**/ ?>