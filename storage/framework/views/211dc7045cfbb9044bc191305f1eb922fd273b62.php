...
<div class="modern-ads-container" <?php echo e($class_dir); ?>>
    <?php
    ...
    <div class="success-popup-overlay" id="successPopup">
        <div class="success-popup-content">
            ...
            <a href="/<?php echo e(Session::get('slug')); ?>" class="btn btn-warning">
                <i class="fas fa-ad"></i>
                My ads
            </a>
        </div>
        ...
        <div class="container">
            <div class="header-content">
                <div class="header-text">
                    <h1 class="page-title"><?php echo e(__('p_myads.my ads')); ?></h1>
                ...
                <div class="header-actions">
                    ...
                    ?>
                    <a  href="<?php echo e(URL::to('/advertise/create')); ?>" class="btn btn-primary btn-lg">
                        <i class="fas fa-plus-circle"></i>
                        <?php echo e(__('p_my_banner_ads.banner advertisement')); ?>
    ...
    <div class="container">
        ...
        <div class="stats-grid">
            ...
            <div class="stat-card">
                ...
                <div class="stat-content">
                    <div class="stat-number">
                        <?php echo e($list->where('sold_status', 1)->count()); ?>
        ...
        <div class="main-card">
            ...
            <div class="filters-section">
                <div class="filter-group">
                    <div class="select-wrapper">
                        <select wire:model="pid" class="form-select">
                            <option value=""> <?php echo e(__('p_myads.select package name')); ?> </option>
                            <?php if(!empty($packages_list)): ?>
                            <?php $__currentLoopData = $packages_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $packages_list_item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($packages_list_item->short_name == "free"): ?>
                            <option value="free"><?php echo e($packages_list_item->name); ?></option>
                            <?php else: ?>
                            <option value="<?php echo e($packages_list_item->id); ?>"><?php echo e($packages_list_item->name); ?></option>
                            <?php endif; ?>
                ...
                <div class="filter-group search-group">
                    <div class="search-wrapper">
                        ...
                        <input type="text" wire:model="search" class="search-input" placeholder="<?php echo e(__('p_myads.search here')); ?>">
                    </div>
                </div>
            </div>
            ...
            <div class="ads-grid">
                ...
                <div class="ad-card">
                    <div class="ad-checkbox">
                        <label class="custom-checkbox">
                            <input type="checkbox" class="hidden-checkbox del_check" wire:model="selectedPosts" value="<?php echo e($post->id); ?>">
                            <span class="checkmark"></span>
                        </label>
                    </div>

                    <div class="ad-image-section">
                        <a href="<?php echo e($slug); ?>" class="ad-image-link">
                            <img src="<?php echo e($img); ?>" alt="<?php echo e($post['title']); ?>" class="ad-image">
                    ...
                    <div class="ad-content">
                        ...
                        <div class="ad-badges">
                            <?php if($check_post_package['ads_type'] != "free"): ?>
                                ...
                                <span class="badge badge-expired"><?php echo e(__('p_myads.expired')); ?></span>
                                <?php else: ?>
                                    <?php if($check_post_package['is_bulk'] != 0): ?>
                                    <span class="badge badge-premium"><?php echo e(__('p_myads.bulk package')); ?> - <?php echo e($check_post_package['ads_type']); ?></span>
                                    <?php else: ?>
                                    <span class="badge badge-premium"><?php echo e($check_post_package['ads_type']); ?></span>
                                    <?php endif; ?>
                                <?php endif; ?>
                            <?php else: ?>
                                <?php if($check_post_package['expired'] == "Expired"): ?>
                            ...
                            <?php if($post['sold_status'] == 1): ?>
                            <span class="badge badge-sold">Sold</span>
                            <?php endif; ?>
                        </div>

                        <h3 class="ad-title">
                            <a href="<?php echo e($slug); ?>"><?php echo e($post["title"]); ?></a>
                        </h3>

                        <div class="ad-price">
                            <?php echo !empty($currency_symbol) ? $currency_symbol[0] : ''; ?><?php echo e(number_format($post["price"])); ?>
                        ...
                        <div class="ad-meta">
                            <div class="meta-item">
                                ...
                                <span><?php echo e($pack_from_date); ?> - <?php echo e($pack_to_date); ?></span>
                            </div>
                            <?php if(!empty($check_post_package['bulk_type'])): ?>
                            <div class="meta-item">
                                <i class="fas fa-clock"></i>
                                <span><?php echo e($check_post_package['bulk_type']); ?></span>
                            </div>
                            <?php endif; ?>
                            <?php if($check_post_package['ads_type'] != "free" && $check_post_package['expired'] != "Expired"): ?>
                            <div class="meta-item">
                                <i class="fas fa-tag"></i>
                                <span>Package: <?php echo !empty($default_currency) ? $default_currency[0] : ''; ?><?php echo e($check_post_package['package_price']); ?></span>
                            </div>
                            <?php endif; ?>
                        </div>
                        ...
                        <div class="ad-stats">
                            <div class="stat">
                                <i class="fas fa-eye"></i>
                                <span><?php echo e($viewcount); ?> <?php echo e(__('p_myads.views')); ?></span>
                            </div>
                        </div>

                        <div class="ad-actions">
                            <div class="action-buttons">
                                <a href="<?php echo e($slug); ?>" target="_blank" class="btn btn-icon" title="View">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a href="<?php echo e(URL::to('/post-edit?id='.$post->id)); ?>" class="btn btn-icon" title="Edit">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <button wire:click.prevent="confirmDelete('<?php echo e($post->id); ?>')" class="btn btn-icon btn-danger" title="Delete">
                                    <i class="fas fa-trash"></i>
                                </button>
                            </div>
                            ...
                            <div class="status-buttons">
                                <?php if($check_post_package['expired'] == "Expired"): ?>
                                    <!-- Expired ad actions -->
                                <?php elseif($post['sold_status'] == 0): ?>
                                    <button wire:click="confirmSoldStatusChange('<?php echo e($post['id']); ?>', 1)" 
                                            wire:loading.attr="disabled"
                                            class="btn btn-outline btn-full">
                                        <i class="fas fa-check-circle"></i>
                                        <?php echo e(__('p_myads.mark as sold')); ?>
                                ...
                                <?php else: ?>
                                    ...
                                    ?>
                                    <?php if(!empty($check_buynow_order) && $check_buynow_order != "delivered"): ?>
                                    <button class="btn btn-outline btn-full disabled" disabled>
                                        <?php echo e(__('p_myads.back to sale')); ?>

                                    </button>
                                    <?php else: ?>
                                    <button wire:click="confirmSoldStatusChange('<?php echo e($post['id']); ?>', 0)" 
                                            wire:loading.attr="disabled"
                                            class="btn btn-outline btn-full">
                                ...
                                <?php if($check_post_package['ads_type'] != "free"): ?>
                                    <?php if($check_post_package['expired'] == "Expired"): ?>
                                    <a href="<?php echo e(URL::to('/selectPackage?post=' . $post['id'] . '')); ?>" class="btn btn-primary btn-full">
                                        <i class="fas fa-bolt"></i>
                                        <?php echo e(__('post_detail.sell fast')); ?>
                                ...
                                <?php else: ?>
                                    ...
                                    <button class="btn btn-primary btn-full republish" data-id='<?php echo e($post["id"]); ?>'>
                                        <i class="fas fa-sync"></i>
                                        <?php echo e(__('p_myads.re publish')); ?>
            ...
            <div class="empty-state">
                ...
                <a href="<?php echo e(URL::to('/post-add')); ?>" class="btn btn-primary">
        ...
        <div class="modal">
            ...
            <div class="modal-body">
                <p class="modal-text">
                    ...
                    <strong><?php echo e(count($selectedPosts)); ?></strong> 
...
<?php $__env->stopPush(); ?><?php /**PATH /home/justreused/htdocs/www.justreused.com/resources/views/livewire/post/show.blade.php ENDPATH**/ ?>