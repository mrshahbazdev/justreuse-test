            ...
            <table class="table-auto w-full">
                <thead>
                    <tr class="border border-l-0 border-r-0">
                        ...
                        <?php if(auth()->user()->can('post-method-active')): ?>
                ...
                $(document).ready(function() {
                    ...
                    function update_package(id, val) {
                        $.ajax({
                            type: 'POST',
                            dataType: 'json',
                            url: "<?php echo e(URL::to('enable_post_method')); ?>",
                            data: {
                                id: id,
                                active: val
                            },
...
<?php endif; ?><?php /**PATH /home/justreused/htdocs/www.justreused.com/resources/views/livewire/admin/post_methods/show.blade.php ENDPATH**/ ?>