        ...
        <div class="flex w-full max-w-4xl rounded-2xl shadow-2xl overflow-hidden">
            <div class="hidden md:flex flex-col justify-center w-1/2 p-12 bg-cover bg-center" style="background-image: url('https://images.unsplash.com/photo-15329996398na7-b0038b056156?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3');">
                <div class="p-8 rounded-lg backdrop-blur-sm" style="background: rgba(245, 245, 245, 0.9);">
                    <img src="<?php echo e(asset('storage/' . \App\Models\Setting::get_logos()['logo'])); ?>" alt="Logo" class="w-54 mb-4">
...
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-xs -mt-4 block"><?php echo e($message); ?></span> <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                    </div>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mt-4">
                    ...
                    <div class="flex justify-center space-x-4">
                        <a href="<?php echo e(URL::to('/auth/google')); ?>" class="social-icon-hover flex items-center justify-center w-12 h-12 text-xl text-gray-600 bg-gray-100 border rounded-full"><i class="fab fa-google"></i></a>
                        <a href="<?php echo e(URL::to('auth/facebook')); ?>" class="social-icon-hover flex items-center justify-center w-12 h-12 text-xl text-gray-600 bg-gray-100 border rounded-full"><i class="fab fa-facebook-f"></i></a>
                    </div>
                </div>
                <p class="mt-6 text-center text-sm text-gray-600">Already registered? <a href="<?php echo e(route('login')); ?>" class="font-bold text-green-600 hover:underline">Sign In</a></p>
            </div>
        </div>
    </div>
        ...
        <script>
            ...
            document.addEventListener('DOMContentLoaded', function () {
                ...
                function handlePhoneInput() {
                    if (phoneInput.isValidNumber()) { window.livewire.find('<?php echo e($_instance->id); ?>').set('phone_country', phoneInput.getNumber()); } else { window.livewire.find('<?php echo e($_instance->id); ?>').set('phone_country', ''); }
...
<?php /**PATH /home/justreused/htdocs/www.justreused.com/resources/views/livewire/auth/register.blade.php ENDPATH**/ ?>