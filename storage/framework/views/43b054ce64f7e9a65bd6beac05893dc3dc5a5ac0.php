  ...
  <?php 
   ...
   <div>
      ...
      <div class="text-white px-6 py-4 border-0 rounded relative mb-4 bg-red-500 alert-danger">
         ...
         <span class="inline-block align-middle mr-8"><b class="capitalize"></b> <?php echo e(Session::get( 'error' )); ?></span>
        ...
        <div class="flex w-full max-w-4xl bg-white rounded-2xl shadow-2xl overflow-hidden">
            ...
            <div class="hidden md:flex flex-col justify-center w-1/2 p-12 bg-cover bg-center text-white" style=" background-image: url('https://images.unsplash.com/photo-1532999639857-b0038b056156?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3');">
                <div class=" bg-opacity-50 p-8 rounded-lg backdrop-blur-sm" style="background:#F5F5F5;">
                    <img src="/storage/<?php echo e($settings['logo']); ?>" alt="JustReused Logo" class="w-64 mb-4">
             ...
             <?php if(session('status')): ?>
			      <div class=" mt-8 mb-8 sm:mx-14">
			         <p class="font-semibold text-sm md:text-base lg:text-lg text-green-600"><?php echo e(session('status')); ?></p>
			      </div>
		      <?php endif; ?>
            ...
            <div class="w-full md:w-1/2 p-8 sm:p-12">
                <form id="loginForm" method="POST" action="<?php echo e(route('login')); ?>" class="space-y-4">
                    ...
                    <div class="text-center mb-8">
                        <img src="/storage/<?php echo e($settings['logo']); ?>" alt="JustReused Logo" class="w-64 mx-auto mb-4 md:hidden">
                        <h2 class="text-3xl font-bold">Welcome Back</h2>
                        <p class="text-gray-500">Sign in to continue your journey</p>
                    </div>
                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'jetstream::components.validation-errors','data' => ['class' => 'mt-6']]); ?>
...
<?php endif; ?>
                    ...
                    <div class="animate-fadeInUp floating-label-group" style="animation-delay: 0.6s;">
                        <div class="relative">
                            ...
                            <input type="email" id="email" name="email" value="<?php echo e($user); ?>" placeholder=" " class="floating-input w-full py-3 pl-12 pr-4 border rounded-lg focus:outline-none focus:ring-2 focus:ring-green-700/50 transition" required>
                    ...
                    <div class="animate-fadeInUp floating-label-group" style="animation-delay: 0.7s;">
                        <div class="relative">
                            ...
                            <input type="password" id="password" name="password" value="<?php echo e($pass); ?>" placeholder=" " class="floating-input w-full py-3 pl-12 pr-12 border rounded-lg focus:outline-none focus:ring-2 focus:ring-green-700/50 transition" required>
                    ...
                    <div class="flex items-center justify-between text-sm animate-fadeInUp" style="animation-delay: 0.8s;">
                        <label for="remember" class="flex items-center text-gray-600 cursor-pointer"><input type="checkbox" name="remember" id="remember" class="h-4 w-4 text-green-600 border-gray-300 rounded focus:ring-green-500"><span class="ml-2"><?php echo e(__('messages.remember me')); ?></span></label>
                        <a href="<?php echo e(route('password.request')); ?>" class="font-semibold text-green-600 hover:text-green-700 hover:underline"><?php echo e(__('messages.forgot your password')); ?></a>
                    </div>
                    <?php endif; ?>
                    <!-- Login Button -->
                    <input type="submit" style="background-color: var(--theme-green);"  value="<?php echo e(__('messages.login')); ?>" class="w-full py-3 text-lg font-bold text-white rounded-lg hover:bg-opacity-90 focus:outline-none focus:ring-4 focus:ring-green-300 transition-all transform hover:-translate-y-1 shadow-lg animate-fadeInUp" style="animation-delay: 0.9s;">
                ...
                <div class="mt-6 animate-fadeInUp" style="animation-delay: 1s;">
                    ...
                    <div class="flex justify-center space-x-4">
                        <a href="<?php echo e(URL::to('/auth/google')); ?>" class="social-icon">
                            <i class="fab fa-google"></i>
                        </a>
                        <a href="<?php echo e(URL::to('auth/facebook')); ?>" class="social-icon">
                            <i class="fab fa-facebook-f"></i>
                        </a>
                    </div>
                </div>
                 <p class="mt-6 text-center text-gray-600 animate-fadeInUp" style="animation-delay: 1.2s;">
                    Not registered? <a href="<?php echo e(route('register')); ?>" class="font-bold text-green-600 hover:text-green-700 hover:underline"><?php echo e(__('messages.newuser')); ?></a>
                </p>
                <?php
						...
						if (!empty($result)) {
						   ...
						   if ($value['enable_sms'] == 1) { ?>
							  ...
							  <span class="align-bottom mx-3.5 inline-block w-12 h-12 leading-10 bg-white rounded-full hidden"><a class="flex items-center justify-center block " href="<?php echo e(URL::to('/loginwithotp')); ?>"><i class="fa fa-mobile fa-2x inline-block relative top-2" aria-hidden="true"></i></a></span>
						<?php }
						}
						?>
            </div>
...
</html><?php /**PATH /home/justreused/htdocs/www.justreused.com/resources/views/auth/login.blade.php ENDPATH**/ ?>