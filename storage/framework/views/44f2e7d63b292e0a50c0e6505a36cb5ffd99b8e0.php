<div class="min-h-screen bg-warm-light py-8">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8 text-center">
            ...
            <div class="mt-6 grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-2xl mx-auto">
                <div class="card-warm rounded-xl p-4 shadow-sm border border-primary-light">
                    <div class="text-2xl font-bold text-primary"><?php echo e($mobile_verified ? '✓' : '!'); ?></div>
                    <div class="text-sm text-gray-600 mt-1">Phone <?php echo e($mobile_verified ? 'Verified' : 'Pending'); ?></div>
                </div>
                <div class="card-warm rounded-xl p-4 shadow-sm border border-primary-light">
                    <div class="text-2xl font-bold text-accent-green"><?php echo e($profile_photo_path ? '✓' : '+'); ?></div>
                    <div class="text-sm text-gray-600 mt-1">Photo <?php echo e($profile_photo_path ? 'Uploaded' : 'Missing'); ?></div>
                </div>
                <div class="card-warm rounded-xl p-4 shadow-sm border border-primary-light">
        ...
        <div class="mb-6 max-w-4xl mx-auto">
            <div class="rounded-xl p-4 <?php echo e(session('class') == 'error' ? 'alert-danger' : 'alert-success'); ?> shadow-sm">
                <div class="flex items-center">
                    <div class="flex-shrink-0">
                        <i class="fa <?php echo e(session('class') == 'error' ? 'fa-exclamation-circle text-danger' : 'fa-check-circle text-success'); ?> text-lg"></i>
                    </div>
                    <div class="ml-3">
                        <p class="text-sm font-medium <?php echo e(session('class') == 'error' ? 'text-danger-dark' : 'text-success-dark'); ?>">
                                            ...
                                            <div class="relative group">
                                                <div class="w-24 h-24 rounded-2xl bg-primary-gradient overflow-hidden border-4 border-white shadow-lg">
                                                    <?php if($profile_photo_path): ?>
                                                        <img src="<?php echo e(Storage::disk('public')->url($profile_photo_path)); ?>" 
                                ...
                                <div class="bg-warm-lighter rounded-xl p-6 border border-primary-light">
                                    ...
                                    <div class="flex items-center justify-between p-4 bg-white rounded-lg border border-success mb-4">
                                        <div class="flex items-center">
                                            ...
                                            <span class="text-gray-800"><?php echo e($currentLocation); ?></span>
                                        </div>
                                        <button type="button" 
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="text" 
                                               ...
                                               value="<?php echo e($currentLocation); ?>">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <select wire:model="p_lang" 
                                            ...
                                            <?php $__currentLoopData = $select_language; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($language->abbr); ?>" <?php echo e($p_lang == $language->abbr ? 'selected' : ''); ?>>
                                        ...
                                        <select wire:model="p_curr" 
                                            ...
                                            <?php $__currentLoopData = $currencies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $currency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($currency->id); ?>" 
                                                        <?php echo e($p_curr == $currency->id ? 'selected' : ''); ?>>
                                                    <?php echo e($currency->short_code); ?> <?php echo $currency->currency_hex; ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <p class="mt-2 text-sm text-gray-500">
                                        ...
                                        <?php echo e(\Carbon\Carbon::parse($date_of_birth)->age); ?> years old
                                    </p>
                                    <?php endif; ?>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="grid grid-cols-3 gap-2">
                                        <?php $__currentLoopData = $gendArr; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <label class="relative flex cursor-pointer">
                                            <input type="radio" 
                                                   wire:model="gender"
                                                   value="<?php echo e($key); ?>"
                                                   class="peer sr-only"
                                                   <?php echo e($gender == $key ? 'checked' : ''); ?>>
                                            <div class="w-full py-3 px-4 text-center border border-gray-300 rounded-xl transition-all duration-200 hover:bg-gray-50 
                                                        ...
                                                        <?php echo e($gender == $key ? 'border-primary bg-primary-lighter text-primary-dark' : 'border-gray-300 text-gray-700'); ?>">
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div>
                                                ...
                                                <?php $__errorArgs = ['stripe_private_key'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <p class="mt-2 text-sm text-danger"><?php echo e($message); ?></p> <?php unset($message);
                                ...
                                <div class="lg:col-span-2">
                                    <div class="bg-warm-lighter rounded-xl p-6 border border-primary-light">
                                        ...
                                        <div class="flex items-center justify-between p-4 bg-white rounded-lg border border-gray-200">
                                            ...
                                            <button type="button" 
                                                    wire:click="$set('show_mobile', <?php echo e($show_mobile ? 0 : 1); ?>)"
                                                    class="relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 <?php echo e($show_mobile ? 'bg-primary' : 'bg-gray-200'); ?> shadow-sm"
                                                    role="switch">
                                                <span class="pointer-events-none inline-block h-5 w-5 transform rounded-full bg-white shadow ring-0 transition duration-200 ease-in-out <?php echo e($show_mobile ? 'translate-x-5' : 'translate-x-0'); ?>"></span>
                                            </button>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="px-8 py-6 bg-warm-light border-t border-gray-200">
                            <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center space-y-4 sm:space-y-0">
                                <div class="flex flex-wrap gap-3">
                                    ...
                                    <a href="<?php echo e(URL::to('change-password')); ?>" 
...
function initializeAutocomplete() {
    ...
    google.maps.event.addListener(autocomplete, 'place_changed', function() {
        ...
        window.livewire.find('<?php echo e($_instance->id); ?>').call('setLocation', placeData);
...
</style><?php /**PATH /home/justreused/htdocs/www.justreused.com/resources/views/livewire/myprofile/show.blade.php ENDPATH**/ ?>