...
<head>
    ...
    <style>
        ...
        /* Plain CSS for Sticky Footer Layout */
...
/* This is the new rule to fix the footer */
.page-wrapper {
    display: flex;
    flex-direction: column;
...
main {
    /* This makes the main content area grow inside the wrapper */
    flex-grow: 1;
}

/* Yahan aap apni baaqi custom CSS classes shamil kar sakte hain */
...
<body class="loading flex flex-col min-h-screen">
...
} elseif ($_instance->childHasBeenRendered('eDtyCkw')) {
    $componentId = $_instance->getRenderedChildComponentId('eDtyCkw');
    $componentTag = $_instance->getRenderedChildComponentTagName('eDtyCkw');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('eDtyCkw');
} else {
    $response = \Livewire\Livewire::mount('mini-chat');
    $html = $response->html();
    $_instance->logRenderedChild('eDtyCkw', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    ...
    <script>
        jQuery(function ($) {
            ...
            if (q && locationInput) {
                ...
                // Your existing search suggestion and geolocation JS code here
                // ... (original search and geolocation logic)
            }
        });
...
</html><?php /**PATH /home/justreused/htdocs/www.justreused.com/resources/views/components/site-layout.blade.php ENDPATH**/ ?>