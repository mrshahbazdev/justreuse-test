        ...
        <div class="flex w-full max-w-4xl bg-white rounded-2xl shadow-2xl overflow-hidden">
            ...
            <div class="hidden md:flex flex-col justify-center w-1/2 p-12 bg-cover bg-center text-white" style="background-image: url('https://images.unsplash.com/photo-15329996398na7-b0038b056156?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3');">
                <div class=" bg-opacity-50 p-8 rounded-lg backdrop-blur-sm" style="background:#F5F5F5;">
                    <img src="<?php echo e(!empty($settings['logo']) ? asset('storage/' . $settings['logo']) : 'https://justreused.com/assets/images/logo-white.png'); ?>" alt="JustReused Logo" class="w-64 mb-4">
            ...
            <div class="w-full md:w-1/2 p-8 sm:p-12 flex flex-col justify-center">
                ...
                <div class="text-center mb-6">
                    <img src="<?php echo e(!empty($settings['logo']) ? asset('storage/' . $settings['logo']) : 'https://justreused.com/assets/images/logo.png'); ?>" alt="JustReused Logo" class="w-64 mx-auto mb-4 md:hidden">
...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'jetstream::components.validation-errors','data' => ['class' => 'mb-4 text-red-500 text-sm']]); ?>
<?php $component->withName('jet-validation-errors'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['class' => 'mb-4 text-red-500 text-sm']); ?>
...
<?php endif; ?>
                ...
                <form method="POST" action="<?php echo e(route('password.email')); ?>" class="space-y-6">
                 ...
                 <p class="mt-8 text-center text-gray-600 animate-fadeInUp" style="animation-delay: 0.7s;">
                    <a href="<?php echo e(route('login')); ?>" class="font-bold text-green-600 hover:text-green-700 hover:underline"><i class="fas fa-arrow-left mr-2"></i><?php echo e(__('messages.back to login')); ?></a>
                </p>
...
</html><?php /**PATH /home/justreused/htdocs/www.justreused.com/resources/views/auth/forgot-password.blade.php ENDPATH**/ ?>