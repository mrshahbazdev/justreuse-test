                                ...
                                <div class="max-h-80 overflow-y-auto">
                                    <?php $__empty_1 = true; $__currentLoopData = $dropdownConversations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $convo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        ...
                                        <button 
                                            ...
                                            <img class="h-10 w-10 rounded-full object-cover mr-3" src="<?php echo e($convo['sender']->profile_photo_path ? asset('storage/app/public/' . $convo['sender']->profile_photo_path) : 'https://placehold.co/40x40'); ?>" alt="Avatar">
                                            <div class="flex-grow">
...
<style>
    ...
    </style><?php /**PATH /home/justreused/htdocs/www.justreused.com/resources/views/layouts/headernew.blade.php ENDPATH**/ ?>