<div class="container mx-auto px-4 py-8">
    ...
    <?php if($isOpen): ?>
        <?php echo $__env->make('livewire.admin.ad-zone-modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php endif; ?>
    ...
    <div class="bg-white shadow-md rounded-lg overflow-hidden">
        <table class="min-w-full leading-normal">
            ...
            <tbody>
                ...
                <tr>
                    <td class="px-5 py-5 border-b text-sm"><?php echo e($zone->name); ?></td>
                    <td class="px-5 py-5 border-b text-sm"><?php echo e($zone->page_location); ?></td>
                    <td class="px-5 py-5 border-b text-sm">$<?php echo e(number_format($zone->price_per_day, 2)); ?></td>
                    <td class="px-5 py-5 border-b text-sm">
                        <span class="<?php echo e($zone->is_active ? 'bg-green-200 text-green-800' : 'bg-red-200 text-red-800'); ?> py-1 px-3 rounded-full text-xs">
                            <?php echo e($zone->is_active ? 'Active' : 'Inactive'); ?>

                        </span>
                    </td>
                    <td class="px-5 py-5 border-b text-sm">
                        <button wire:click="edit('<?php echo e($zone->id); ?>')" class="text-indigo-600 hover:text-indigo-900">Edit</button>
                        <button wire:click="delete('<?php echo e($zone->id); ?>')" class="text-red-600 hover:text-red-900 ml-4">Delete</button>
                    </td>
                </tr>
...
<?php /**PATH /home/justreused/htdocs/www.justreused.com/resources/views/livewire/admin/ad-zones.blade.php ENDPATH**/ ?>