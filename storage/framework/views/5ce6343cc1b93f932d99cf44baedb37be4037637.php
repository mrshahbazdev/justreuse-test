    ...
    <div class="shell p-4 sm:p-6 md:p-8 bg-white rounded-lg shadow-md">
        <header class="flex flex-col justify-between mb-6">
            <div class="steps-wrap flex gap-4 border-b pb-4">
                <div class="step flex-1 text-center <?php echo e($currentStep == 1 ? 'active' : ''); ?>">
                    <span class="block text-sm text-gray-500">Step 1</span>
                    <span class="font-semibold">Basic Info</span>
                </div>
                <div class="step flex-1 text-center <?php echo e($currentStep == 2 ? 'active' : ''); ?>">
        ...
        <form wire:submit.prevent="updatePost">
            ...
            <div style="<?php echo e($currentStep == 1 ? 'display:block;' : 'display:none;'); ?>">
                <div class="space-y-6">
                    <div>
                        ...
                        <select wire:model="selectedParentCategory" class="mt-1 block w-full p-2 border border-gray-300 rounded-md shadow-sm" required>
                         ...
                         <?php $__errorArgs = ['selectedParentCategory'];
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700">Sub-Category in <?php echo e($parentCategory->title ?? ''); ?></label>
                        <div class="categories grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-2 mt-2">
                            ...
                            <button class="seg p-3 text-sm border rounded-md transition <?php echo e($selectedChildCategory == $child->id ? 'active' : 'bg-gray-50 hover:bg-gray-100'); ?>" type="button" wire:click="selectChildCategory(<?php echo e($child->id); ?>)">
                                <?php echo e($child->title); ?>

                            </button>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                        <?php $__errorArgs = ['selectedChildCategory'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-xs"><?php echo e($message); ?></span> <?php unset($message);
                    ...
                    <?php if($customFields->count() > 0): ?>
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 pt-4 border-t">
                            <?php $__currentLoopData = $customFields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                 <div class="space-y-1">
                                    <label class="block text-sm font-medium text-gray-700"><?php echo e($field->name); ?> <?php if($field->required != '0'): ?> <span class="text-red-800">*</span> <?php endif; ?></label>
                                    <?php
                                        $fieldKey = $field->id . '_' . $field->form_field_name;
                                    ?>
                                    <?php if(in_array($field->type, ["text", "number", "date"])): ?>
                                        <input type="<?php echo e($field->type); ?>" wire:model.lazy="customFieldsData.<?php echo e($fieldKey); ?>" class="block w-full p-2 border border-gray-300 rounded-md">
                                    <?php elseif(in_array($field->type, ["select", "radio-group"])): ?>
                                        <select wire:model.lazy="customFieldsData.<?php echo e($fieldKey); ?>" class="block w-full p-2 border border-gray-300 rounded-md">
                                             <option value="">Select <?php echo e($field->name); ?></option>
                                             <?php $__currentLoopData = \App\Models\TblFieldsOption::where('field_id', $field->id)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($option->value); ?>"><?php echo e($option->key); ?></option>
                                             <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    <?php endif; ?>
                                    <?php $__errorArgs = ['customFieldsData.'.$fieldKey];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-xs"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div style="<?php echo e($currentStep == 2 ? 'display:block;' : 'display:none;'); ?>">
                <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <select wire:model="currency_id" class="mt-1 block w-full p-2 border border-gray-300 rounded-md shadow-sm">
                                <?php $__currentLoopData = $currencies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $currency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($currency->id); ?>"><?php echo e($currency->short_code); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                    </div>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="my-6">
                        ...
                        <div class="flex flex-wrap gap-4 mt-2">
                            <?php $__currentLoopData = $existingImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $imagePath): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="relative">
                                <img src="<?php echo e(Storage::url($imagePath)); ?>" class="h-24 w-24 object-cover rounded-lg border">
                                <button type="button" wire:click="removeExistingImage(<?php echo e($index); ?>)" class="absolute -top-2 -right-2 bg-red-500 text-white rounded-full h-6 w-6 flex items-center justify-center text-xs font-bold">&times;</button>
                            </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    </div>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="my-6">
                        ...
                        <div class="flex flex-wrap gap-4 mt-2">
                            ...
                            <div class="relative">
                                <img src="<?php echo e($image->temporaryUrl()); ?>" class="h-24 w-24 object-cover rounded-lg border">
                                <button type="button" wire:click="removeNewImage(<?php echo e($index); ?>)" class="absolute -top-2 -right-2 bg-red-500 text-white rounded-full h-6 w-6 flex items-center justify-center text-xs font-bold">&times;</button>
                            </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    </div>
...
<?php /**PATH /home/justreused/htdocs/www.justreused.com/resources/views/livewire/post/edit.blade.php ENDPATH**/ ?>