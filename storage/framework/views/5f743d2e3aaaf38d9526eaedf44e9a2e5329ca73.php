...
} elseif ($_instance->childHasBeenRendered('sQwaevQ')) {
    $componentId = $_instance->getRenderedChildComponentId('sQwaevQ');
    $componentTag = $_instance->getRenderedChildComponentTagName('sQwaevQ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('sQwaevQ');
} else {
    $response = \Livewire\Livewire::mount('mini-chat');
    $html = $response->html();
    $_instance->logRenderedChild('sQwaevQ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
</html><?php /**PATH /home/justreused/htdocs/www.justreused.com/resources/views/layouts/frontnewhome.blade.php ENDPATH**/ ?>