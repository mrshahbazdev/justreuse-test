                ...
                <table style="width: 100%; max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 8px; box-shadow: 0 4px 15px rgba(0,0,0,0.05);">
                    <tr>
                        <td style="background-color: #39763a; padding: 30px 20px; text-align: center; border-radius: 8px 8px 0 0;">
                            <img src="<?php echo e(asset('storage/' . \App\Models\Setting::get_logos()['logo'])); ?>" alt="Logo" width="150">
                            <h1 style="color: #ffffff; font-size: 28px; margin-top: 20px; margin-bottom: 0;">Your Verification Code</h1>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 40px;">
                            <h2 style="color: #333333; font-size: 22px; margin-top: 0;">Hello <?php echo e($user->name); ?>,</h2>
                            ...
                            <div style="text-align: center; margin: 30px 0;">
                                <p style="display: inline-block; background-color: #f0f2f5; color: #39763a; padding: 15px 30px; border-radius: 5px; font-weight: bold; font-size: 28px; letter-spacing: 5px;"><?php echo e($otp); ?></p>
                            </div>
...
<?php /**PATH /home/justreused/htdocs/www.justreused.com/resources/views/emails/otp-email.blade.php ENDPATH**/ ?>