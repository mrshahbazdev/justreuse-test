...
<link rel="stylesheet" href="https://code.jquery.com/ui/1.13.2/themes/base/jquery-ui.css">
	...
	if($dir_rtl =="false"){  ?>
	<div class="search_prod_loc search-field-open absolute top-full z-10 lg:relative lg:top-auto bg-white w-full lg:w-2/5 xl:w-1/2 float-left hidden lg:block p-3 sm:p-5 lg:p-0 shadow lg:shadow-none" style="<?php echo e(request()->is('/') ? 'display:none;' : ''); ?>">
		...
		<div class="w-full flex lg:block flex-col float-left xl:px-6">
				...
				<label for="location" class="sr-only"><?php echo e(__('messages.location')); ?></label>
					<!--<span class="z-20 h-full leading-snug font-normal absolute text-center text-green-700 absolute bg-transparent rounded text-base items-center justify-center w-6 pl-2 py-3">
						<img class="mt-1" src="<?php echo e(URL::to('images/frontend/iconfinder_search_126577.png')); ?>"></span>-->
					<input type="text" id="term" placeholder="<?php echo e(__('messages.search product/category')); ?>" value="<?php echo (!empty(request()->s) ? request()->s : "") ?>" class=" px-6 rounded-full py-3 relative bg-gray-100 rounded text-sm outline-none focus:outline-none w-full lg:mr-0 h-12 lg:h-14 ui-autocomplete-input">
		...
		<div class="search_prod_loc search-field-open absolute top-full z-10 lg:relative lg:top-auto bg-white w-full lg:w-2/5 xl:w-1/2 float-left lg:block p-3 sm:p-5 lg:p-0 shadow lg:shadow-none"
		     style="<?php echo e(request()->is('/') ? 'display:none;' : ''); ?>">
		...
		<div class="w-full float-left xl:px-6">
			...
			<label for="location" class="sr-only"><?php echo e(__('messages.location')); ?></label>
				<span class="z-20 h-full leading-snug font-normal absolute text-center text-green-700 absolute bg-transparent rounded text-base items-center justify-center w-7 pr-2 py-3 pb-2">
					<img src="<?php echo e(URL::to('images/frontend/Group111.png')); ?>"></span>
				<input type="text" id="location" placeholder="<?php echo e(__('messages.location')); ?>" value="<?php echo $lc; ?>" class="w-full  border border-green-500 lg:border-0 px-3 py-3 relative bg-white rounded text-sm shadow outline-none focus:outline-none  w-full pr-9 sm:ml-3 h-11">
			</div>
			...
			<div class="relative flex items-center float-left sm:w-2/4 w-full">
				<div class=" w-full flex">
					<span class="z-20 h-full leading-snug font-normal absolute text-center text-green-700 absolute bg-transparent rounded text-base items-center justify-center w-6 pr-2 py-3">
						<img class="mt-1" src="<?php echo e(URL::to('images/frontend/iconfinder_search_126577.png')); ?>"></span>
					<input type="text" id="term" placeholder="<?php echo e(__('messages.search product/category')); ?>" value="<?php echo (!empty(request()->s) ? request()->s : "") ?>" class="border border-green-500 lg:border-0 px-3 py-3 relative  bg-white rounded text-sm shadow outline-none focus:outline-none w-full pr-9 ml-3 lg:ml-0 xl:ml-3 h-11">
					<div class="absolute top-full bg-white left-0 right-0 z-40"><ul class="z-20 top-full left-0 bg-white shadow-md" id="filtered_search"></ul></div>
...
<!--End - AR Alignment -->
	...
	<?php /**PATH /home/justreused/htdocs/www.justreused.com/resources/views/layouts/header-search-bar.blade.php ENDPATH**/ ?>