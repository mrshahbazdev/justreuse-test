...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(URL::to('css/fontawesome.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(URL::to('css/intlTelInput.css')); ?>" />
    ...
    <script src="<?php echo e(URL::to('js/intlTelInput.min.js')); ?>"></script>
<style>
.forest-bg-green{
...
<body>
    ...
    <div class="font-sans text-gray-900 antialiased">
        <div class="w-full mt-10 mb-10 lg:mt-28 lg:mb-20 " <?php echo e($class_dir); ?>>
                    ...
                    <div class="border-0 pb-6  my-4 bg-gray-100 w-full  mx-auto overflow-hidden  lg:w-6/12 items-center">
                        <div class="w-full">
                            ...
                            <div class="w-full inline-block text-center mt-8 mb-4">
                                <a href="<?php echo e(URL::to('/')); ?>"><img class="mx-auto w-48 object-contain" src="<?php echo e(URL::to('storage/'.$settings['logo'])); ?>"></a>
                            </div>
                            <?php echo e($slot); ?>
	...
	<div class="font-sans text-gray-900 antialiased">
        <div class="w-full mt-8 mb-10 lg:mt-16 lg:mb-20 " <?php echo e($class_dir); ?>>
            <div class="container px-4 mx-auto">
                <div class="block lg:flex  lg:flex-row-reverse lg:space-x-8 lg:space-x-reverse ...">
					<div class="w-full lg:w-8/12 xl:w-7/12 mx-auto">
						<div class="text-center mb-16">
							<a class="inline-block outline-none focus:outline-none" href="<?php echo e(URL::to('/')); ?>"><img class="mx-auto w-48 object-contain" src="<?php echo e(URL::to('storage/'.$settings['logo'])); ?>"></a>
						</div>
...
?>
			...
			<div class="py-2 pt-6 md:pt-10 md:w-4/12">
				<div class="footer_logo_section w-full lg:w-3/4">
					<div class="footer_logo text-center">
						<img class="inline-block " src="<?php echo e(URL::to('storage/'.$settings['logo'])); ?>">
					</div>
					...
					if (!empty($post_methods)) {
						...
						if (in_array("bannerads", $check_banner_ads)) { ?>
							<button class="text-white px-2  focus:outline-none rounded py-2 btn-gradiant  rounded-sm mt-8 w-full  ease-linear transition-all duration-500">
								<a href="<?php echo e(URL::to('/pages/banner-ads')); ?>">
					...
					<ul class="w-full mt-8 text-center md:text-left">
						<li class="inline-block px-3 lg:pr-10 lg:pl-0"><a href="#" class="text-base font-semibold text-white"></a><a href="https://www.facebook.com/" target="_blank"><img src="<?php echo e(URL::to('images/frontend/fb.png')); ?>"></a></li>
						<li class="inline-block px-3 lg:pr-10 lg:pl-0"><a href="#" class="text-base font-semibold text-white"></a><a href="https://www.instagram.com/" target="_blank"><img src="<?php echo e(URL::to('images/frontend/insta.png')); ?>"></a></li>
						<li class="inline-block px-3 lg:pr-10 lg:pl-0"><a href="#" class="text-base font-semibold text-white"></a><a href="https://www.twitter.com/" target="_blank"><img src="<?php echo e(URL::to('images/frontend/twitter.png')); ?>"></a></li>
					</ul>
					</div>
				</div>
			<!--End EN Alignment-->
	<?php } else { ?>
			...
			<div class="py-2 pt-6 md:pt-10 md:w-4/12">
					...
					<ul class="w-full mt-8 text-center md:text-right">
						<li class="inline-block px-3 lg:pl-10 lg:pr-0"><a href="#" class="text-base font-semibold text-white"></a><a href="https://www.facebook.com/" target="_blank"><img src="<?php echo e(URL::to('images/frontend/fb.png')); ?>"></a></li>
						<li class="inline-block px-3 lg:pl-10 lg:pr-0"><a href="#" class="text-base font-semibold text-white"></a><a href="https://www.instagram.com/" target="_blank"><img src="<?php echo e(URL::to('images/frontend/insta.png')); ?>"></a></li>
						<li class="inline-block px-3 lg:pl-10 lg:pr-0"><a href="#" class="text-base font-semibold text-white"></a><a href="https://www.twitter.com/" target="_blank"><img src="<?php echo e(URL::to('images/frontend/twitter.png')); ?>"></a></li>
					</ul>
				</div>
				</div>
			<!--END AR Alignment-->
	<?php } ?>
				...
				<div class="py-2 pt-6 md:pt-10 md:w-3/12">
				    ...
				    <ul>
				        <?php if(!empty($poplocations)): ?>
				            
				            <?php $__currentLoopData = $poplocations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $pop_location): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				                <li class="pb-1.5"><a href="#" class="text-base font-semibold text-white"><?php echo e($key); ?></a></li>
				            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
				        <?php elseif(!empty($pop_locations)): ?>
...
</html><?php /**PATH /home/justreused/htdocs/www.justreused.com/resources/views/layouts/guest.blade.php ENDPATH**/ ?>