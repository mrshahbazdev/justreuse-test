<div class="flex items-center justify-center min-h-screen p-4 ">
    <div class="w-full max-w-md  rounded-2xl shadow-xl p-8 sm:p-12">
        <div class="text-center mb-6">
            ...
            <p class="text-gray-500 mt-2">An OTP has been sent to <span class="font-medium text-gray-700"><?php echo e($email); ?></span>. Please enter it below.</p>
        </div>
...
<?php /**PATH /home/justreused/htdocs/www.justreused.com/resources/views/livewire/auth/verify-otp.blade.php ENDPATH**/ ?>