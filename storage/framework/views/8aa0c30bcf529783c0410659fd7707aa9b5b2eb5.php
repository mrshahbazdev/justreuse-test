   ...
   <?php endif; ?>
	...
	<div class="w-full float-left">
		<div class="container mx-auto px-4">
			<h1 class="text-xl md:text-2xl font-bold text-black my-4 sm:my-6 lg:my-8 uppercase"><?php echo e(__('messages.my banner ads')); ?></h1>
		</div>
	</div>
			...
			<div class="container mx-auto px-4">
			   <div class="p-5 w-full bg-white shadow-lg float-left mb-8 sm:mb-12 md:mb-16 lg:mb-20 lg:p-12 relative -mt-36">
				  ...
				  <form id="BannerAdsForm" method="post" action="#" enctype="multipart/form-data">
					 ...
					 <div class="mb-4 w-full float-left lg:mb-14">
						<!--<div class="m-4 md:w-6/12">-->
						   <label class="w-full m-0 text-lg text-gray-800 font-semibold pb-4 inline-block"><?php echo e(__('p_my_banner_ads.banner image for website')); ?> (1200 X 400) <span class="text-red-500">*</span></label>
						...
						<div class="my-2 w-full lg:w-2/4 rounded-lg lg:-my-4 float-right">
						   <label class="text-gray-500 text-base font-medium"><?php echo e(__('p_my_banner_ads.web link')); ?> <span class="text-red-500">*</span></label>
					 ...
					 <div class="mb-4 w-full float-left lg:mb-14">
						<!--<div class="m-4 md:w-6/12">-->
						   <label class="w-full m-0 text-lg text-gray-800 font-semibold pb-4 inline-block"><?php echo e(__('p_my_banner_ads.banner image for mobile app')); ?> (1024 X 500)<span class="text-red-500">*</span></label>
							<div class="w-full lg:w-2/5 rounded-lg float-left">
							   <div class="w-full bg-gray-100 border-l-2 border-gray-400 my-2 lg:w-2/4 rounded-lg choose-file float-left">
						...
						<!--<div class="m-4 md:w-6/12">-->
							<div class="my-2 w-full lg:w-2/4 rounded-lg lg:-my-4 float-right">
							   <label class="text-gray-500 text-base font-medium"><?php echo e(__('p_my_banner_ads.app link')); ?> <span class="text-red-500">*</span></label>
					 ...
					 <div class="w-full float-left">
						<label class="m-0 text-lg text-gray-800 font-semibold pb-4"><?php echo e(__('p_my_banner_ads.where your banner display in live')); ?>? <span class="text-red-500">*</span></label>
						<div class="w-full float-left">
							<div class="w-full my-2 float-left">
								<select required name="banner_display_page" id="banner_display_page" class="my-2 banner_display_page border-l-4 border-gray-400 bg-gray-100 rounded-lg w-full py-4 px-3 text-gray-700 leading-tight focus:outline-none">
								   <option value="">[--- <?php echo e(__('p_my_banner_ads.select page')); ?> ---]</option>
								   <option value="home"><?php echo e(__('p_my_banner_ads.in home page')); ?></option>
								   <option value="search"><?php echo e(__('p_my_banner_ads.in search list page')); ?></option>
								</select>
							</div>
						</div>
					 </div>
					 ...
					 <div class="m-4 select_banner_category">
						<label class="text-gray-700 text-sm font-bold"><?php echo e(__('p_my_banner_ads.for which category you are going to add banner')); ?>? <span class="text-red-500">*</span></label>
						<select name="banner_category" class="my-2 banner_category appearance-none border-l-2 border-gray-400 bg-gray-100 rounded w-full py-4 px-3 text-gray-700 leading-tight focus:outline-none">
						   <option hidden="" disabled="disabled" selected="selected" value=""><?php echo e(__('p_myads.please select')); ?></option>
						   <?php
					 ...
					 <div class="based_on_selected_page">
						...
						<div class="m-4">
						   <label class="text-gray-700 text-sm font-bold"><?php echo e(__('p_my_banner_ads.when your banner display in live')); ?>? <span class="bg-yellow-500 p-1 text-white rounded mt-2 md:mt-0 md:float-right per_day_amt_txt"> $100 Per day</span></label>
						...
						<div class="md:flex">
						   <div class="m-4 md:w-6/12">
							  <label class="text-gray-700 text-sm font-bold"><?php echo e(__('p_my_banner_ads.start date')); ?> <span class="text-red-500">*</span></label>
						   ...
						   <div class="m-4 md:w-6/12">
							  <label class="text-gray-700 text-sm font-bold"><?php echo e(__('p_my_banner_ads.end date')); ?> <span class="text-red-500">*</span></label>
						...
						<div class="block p-2 border-b border-solid border-white">
						   <span class="text-gray-700 text-sm font-bold"><?php echo e(__('p_my_banner_ads.payment methods')); ?> <span class="text-red-500">*</span></span>
						   <div class="mt-2 md:flex">
							  ...
							  ?>
								 <label class="inline-flex items-center mb-2 <?php echo e($class); ?>">
									<input type="radio" class="form-radio" name="payment_type" value="<?php echo e($p['name']); ?>" <?php echo e($checkString); ?>>
				  ...
				  <div class="text-center">
					 <p><?php echo e(__('p_my_banner_ads.payment methods are not activated, please contact admin')); ?>!</p>
				  </div>
				  <?php endif; ?>
			   </div>
			</div>
...
<script>
   ...
   function get_banner_price(page, cat_id) {
      $.ajax({
         type: 'POST',
         dataType: 'json',
         url: "<?php echo e(URL::to('get_banner_price')); ?>",
         data: {
            page: page,
            cat_id: cat_id
         },
...
<?php echo $__env->make('layouts.frontendother', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/justreused/htdocs/www.justreused.com/extra/postplugins/bannerads/src/show.blade.php ENDPATH**/ ?>