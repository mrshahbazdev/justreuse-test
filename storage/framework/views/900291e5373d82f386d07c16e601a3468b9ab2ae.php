...
<body class="loading">
    ...
    <div id="preloader">
        <img src="<?php echo e(asset('storage/'.$settings['logo'])); ?>" alt="Site Logo">
...
} elseif ($_instance->childHasBeenRendered('qtmzNlD')) {
    $componentId = $_instance->getRenderedChildComponentId('qtmzNlD');
    $componentTag = $_instance->getRenderedChildComponentTagName('qtmzNlD');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('qtmzNlD');
} else {
    $response = \Livewire\Livewire::mount('mini-chat');
    $html = $response->html();
    $_instance->logRenderedChild('qtmzNlD', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
</html><?php /**PATH /home/justreused/htdocs/www.justreused.com/resources/views/layouts/frontnew.blade.php ENDPATH**/ ?>