        ...
        <main>
          ...
          ?>
          <div>
              <input type="hidden" id="category" value="<?php echo e(request()->c ?? ''); ?>">
              <input type="hidden" id="subcategory" value="">
              <input type="hidden" id="is_search" value="<?php echo e(session()->has('IsSearch') ?? ''); ?>">
          </div>
            <section class="hero-section">
                ...
                <div class="hero-image-grid">
                    <?php if(isset($random_categories) && $random_categories->count()): ?>
                        <?php $__currentLoopData = $random_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                                $cat_img = !empty($category->image) ? asset('storage/' . $category->image) : 'https://img.icons8.com/color/96/generic-box.png';
                            ?>
                            <a href="<?php echo e($searchUrl . '&c=' . $category->slug); ?>" class="icon-card">
                                <img src="<?php echo e($cat_img); ?>" alt="<?php echo e($category->title); ?>">
            ...
            <section class="listings-section">
                ...
                <div class="category-buttons">
                    <?php $__currentLoopData = $main_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $main_category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        ?>
                        <a href="<?php echo e($searchUrl . '&c=' . $main_category->slug); ?>" class="category-btn">
                            <img src="<?php echo e($cat_img); ?>" alt="<?php echo e($main_category->title); ?>">
                            <?php echo e($main_category->title); ?>
            ...
            <section class="listings-section">
                <h2 class="section-title"><?php echo e(__('landing.top ads')); ?></h2>
                 <div class="product-grid">
                    <?php $__empty_1 = true; $__currentLoopData = $top_ads_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ad): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            ...
            <section class="listings-section">
                <h2 class="section-title"><?php echo e(__('landing.feature ads')); ?></h2>
                <div class="product-grid">
                    <?php $__empty_1 = true; $__currentLoopData = $featurs_ad_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ad): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <?php echo App\Models\Setting::htmlAdBlock($ad['id']); ?>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        <?php /**PATH /home/justreused/htdocs/www.justreused.com/resources/views/livewire/user-landing-component.blade.php ENDPATH**/ ?>