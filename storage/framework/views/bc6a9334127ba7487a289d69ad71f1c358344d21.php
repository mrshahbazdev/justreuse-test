...
unset($__errorArgs, $__bag); ?>
                ...
                <?php endif; ?>
                <?php if($banner_type !=3 && $banner_type !=2): ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <?php endif; ?>
                <?php if($banner_type !=1 && $banner_type !=2): ?>
                <div class="flex flex-col mb-4 md:w-1/2 div_mapbox_api_key">
                    ...
                    <?php $__errorArgs = ['mapbox_api_key'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500"><?php echo e($message); ?></span><?php unset($message);
...
</div><?php /**PATH /home/justreused/htdocs/www.justreused.com/resources/views/livewire/admin/settings/home-banner-map.blade.php ENDPATH**/ ?>