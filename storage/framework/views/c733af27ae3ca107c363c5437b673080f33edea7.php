            ...
            <div class="double-scroll-div">
                <table class="table-auto w-full">
                    ...
                    <tbody class="border border-b-0 border-l-0 border-r-0 tablelast">
                        ...
                        <?php $__currentLoopData = $BuynowOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $BuynowOrder): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td class="border-b px-4 py-2 text-left">
                                <p class="text-sm pt-1">Name : <b><?php echo e($BuynowOrder->user_name); ?></b></p>
                                <p class="text-sm pt-1">Email : <b><?php echo e($BuynowOrder->user_email); ?></b></p>
                            </td>
                            <td class="border-b px-4 py-2 text-left">
                                <?php
                                ...
                                ?>
                                <p class="text-sm pt-1">Name : <b><?php echo e($seller_name); ?></b></p>
                                <p class="text-sm pt-1">Email : <b><?php echo e($seller_email); ?></b></p>
                            </td>
                            <td class="border-b px-4 py-2 text-left">
                                <p class="text-sm pt-1">Post Name : <b><?php echo e($BuynowOrder->post_title); ?></b></p>
                                <p class="text-sm pt-1">Total Amount : <b><?php echo $BuynowOrder->currency_hex; ?><?php echo e($BuynowOrder->total); ?></b></p>
                            </td>
                            <td class="border-b px-4 py-2 text-left">
                                <p class="text-sm pt-1">status : <b><?php echo e($BuynowOrder->order_status); ?></b></p>
                                <p class="text-sm pt-1">Order Id : <b><?php echo e($BuynowOrder->orderId); ?></b></p>
...
</div><?php /**PATH /home/justreused/htdocs/www.justreused.com/resources/views/livewire/admin/buynow_orders/show.blade.php ENDPATH**/ ?>