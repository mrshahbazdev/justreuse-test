    ...
    <div class="container mx-auto px-4 py-12">
        ...
        <div class="flex items-center justify-center mb-12">
            <div class="flex items-center">
                <div class="step-indicator flex items-center justify-center w-10 h-10 rounded-full font-bold <?php echo e($currentStep >= 1 ? ($currentStep > 1 ? 'completed' : 'active') : ''); ?>">1</div>
                <div class="h-0.5 w-16 <?php echo e($currentStep > 1 ? 'bg-green-600' : 'bg-gray-300'); ?>"></div>
            </div>
            <div class="flex items-center">
                <div class="step-indicator flex items-center justify-center w-10 h-10 rounded-full font-bold <?php echo e($currentStep >= 2 ? ($currentStep > 2 ? 'completed' : 'active') : ''); ?>">2</div>
                <div class="h-0.5 w-16 <?php echo e($currentStep > 2 ? 'bg-green-600' : 'bg-gray-300'); ?>"></div>
            </div>
             <div class="flex items-center">
                <div class="step-indicator flex items-center justify-center w-10 h-10 rounded-full font-bold <?php echo e($currentStep >= 3 ? ($currentStep > 3 ? 'completed' : 'active') : ''); ?>">3</div>
                <div class="h-0.5 w-16 <?php echo e($currentStep > 3 ? 'bg-green-600' : 'bg-gray-300'); ?>"></div>
            </div>
            <div class="step-indicator flex items-center justify-center w-10 h-10 rounded-full font-bold <?php echo e($currentStep === 4 ? 'active' : ''); ?>">✓</div>
        </div>

        <div x-data="{ currentStep: <?php if ((object) ('currentStep') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($_instance->id); ?>').entangle('<?php echo e('currentStep'->value()); ?>')<?php echo e('currentStep'->hasModifier('defer') ? '.defer' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($_instance->id); ?>').entangle('<?php echo e('currentStep'); ?>')<?php endif; ?> }">
                ...
                <div>
                    ...
                    <select wire:model="ad_zone_id" class="w-full p-3 border border-gray-300 rounded-lg focus:ring-green-500 focus:border-green-500">
                        ...
                        <?php $__currentLoopData = $adZones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $zone): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($zone->id); ?>"><?php echo e($zone->name); ?> (Price: <?php echo $currencySymbol; ?><?php echo e(number_format($zone->price_per_day, 2)); ?>/day)</option>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <?php $__currentLoopData = $templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $template): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <label class="border rounded-lg p-4 cursor-pointer transition-all <?php echo e($ad_template_id == $template->id ? 'bg-green-50 border-green-500 ring-2 ring-green-500' : 'bg-white border-gray-200 hover:border-gray-400'); ?>">
                                <input type="radio" wire:model="ad_template_id" value="<?php echo e($template->id); ?>" class="hidden">
                                <h4 class="font-semibold text-center mb-2"><?php echo e($template->name); ?></h4>
                                <div class="border rounded-md p-2 bg-gray-50 pointer-events-none scale-50 origin-top">
                                    <?php echo str_replace(['__IMAGE_URL__', '__HEADLINE__', '__SUBTITLE__', '__LINK__', '__CTA_TEXT__', '__LOGO_URL__', '__WIDTH__', '__HEIGHT__'], ['https://placehold.co/600x400/e2e8f0/e2e8f0?text=Preview', 'Template Preview', 'Subtitle preview', '#', 'Button', 'https://placehold.co/40x40', '100%', 'auto'], $template->html_content ?? ''); ?>

                                </div>
                            </label>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                    <?php $__errorArgs = ['ad_template_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-sm mt-1"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="text-right pt-4 border-t">
                    <button wire:click="goToStep(2)" type="button" class="bg-green-600 text-white font-bold py-3 px-6 rounded-lg disabled:bg-gray-400" <?php if(!$ad_zone_id || !$ad_template_id): ?> disabled <?php endif; ?>>
            ...
            <div x-show="currentStep === 2" x-transition>
                 <form wire:submit.prevent="createAdvertisementAndProceedToPayment" class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    <div class="lg:col-span-1 bg-white rounded-lg shadow-lg border p-8 space-y-6">
                        ...
                        <?php if(in_array('__HEADLINE__', $templatePlaceholders)): ?>
                        <div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <?php if(in_array('__SUBTITLE__', $templatePlaceholders)): ?>
                        <div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <?php if(in_array('__LINK__', $templatePlaceholders)): ?>
                        <div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <?php if(in_array('__CTA_TEXT__', $templatePlaceholders)): ?>
                        <div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <?php if(in_array('__IMAGE_URL__', $templatePlaceholders)): ?>
                        <div>
                            ...
                            <?php if($image && !$errors->has('image')): ?>
                                <img src="<?php echo e(asset('storage/livewire-tmp/' . $image->getFilename())); ?>" class="mt-4 h-24 rounded-lg border object-cover">
                            <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <?php if(in_array('__LOGO_URL__', $templatePlaceholders)): ?>
                        <div>
                            ...
                            <?php if($logo && !$errors->has('logo')): ?>
                                <img src="<?php echo e(asset('storage/livewire-tmp/' . $logo->getFilename())); ?>" class="mt-4 h-16 w-16 rounded-full border object-cover">
                            <?php endif; ?>
                             ...
                             <div class="bg-white rounded-lg shadow-lg border p-6">
                                ...
                                <div x-show="view === 'mobile'" x-transition class="transition-all duration-300" style="display: none;">
                                    <div class="device-mobile mx-auto">
                                        <div class="device-mobile-screen"><div class="device-mobile-notch"></div><div class="w-full h-full overflow-y-auto"><?php echo $previewHtml; ?></div></div>
                                    </div>
                                </div>
                             </div>
                             <div class="mt-6 bg-white rounded-lg shadow-lg border p-6">
                                ...
                                <div class="space-y-4">
                                     <div class="grid grid-cols-2 gap-6">
                                        <div><label class="block text-sm font-medium mb-1">Start Date *</label><input type="date" wire:model="start_date" class="mt-1 w-full p-2 border border-gray-300 rounded-md focus:ring-green-500 focus:border-green-500"><?php $__errorArgs = ['start_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-sm mt-1"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?></div>
                                        <div><label class="block text-sm font-medium mb-1">End Date *</label><input type="date" wire:model="end_date" class="mt-1 w-full p-2 border border-gray-300 rounded-md focus:ring-green-500 focus:border-green-500"><?php $__errorArgs = ['end_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-sm mt-1"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?></div>
                                    ...
                                    <div class="pt-4 border-t space-y-2">
                                        <div class="flex justify-between text-gray-600"><span>Price per day:</span> <span class="font-semibold"><?php echo $currencySymbol; ?><?php echo e(number_format($pricePerDay, 2)); ?></span></div>
                                        <div class="flex justify-between text-gray-600"><span>Live Days:</span> <span class="font-semibold"><?php echo e($liveDays); ?></span></div>
                                        <div class="flex justify-between text-2xl font-bold text-gray-800 mt-4 pt-4 border-t"><span>Total Amount:</span> <span class="text-green-600"><?php echo $currencySymbol; ?><?php echo e(number_format($totalAmount, 2)); ?></span></div>
                                    </div>
                                    <div class="mt-6">
                                        <h3 class="text-md font-semibold text-gray-700 mb-3">Payment Method *</h3>
                                        <div class="space-y-3">
                                            <?php $__currentLoopData = $paymentMethods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $method): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <label class="flex items-center p-3 border rounded-lg cursor-pointer transition-colors <?php echo e($selectedPaymentMethod == $method['name'] ? 'bg-green-50 border-green-500 ring-1 ring-green-500' : 'border-gray-200 hover:border-gray-400'); ?>">
                                                    <input type="radio" wire:model="selectedPaymentMethod" name="payment_type" value="<?php echo e($method['name']); ?>" class="h-4 w-4 text-green-600 focus:ring-green-500">
                                                    <span class="ml-3 font-medium text-gray-700"><?php echo e($method['display_name']); ?></span>
                                                </label>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </div>
                                        <?php $__errorArgs = ['selectedPaymentMethod'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-sm mt-1"><?php echo e($message); ?></span> <?php unset($message);
                ...
                <div class="max-w-md mx-auto bg-white rounded-lg shadow-lg p-8" wire:ignore>
                    ...
                    <p class="text-gray-600 mb-6">Total Amount: 
                        <span id="payment-amount" class="font-bold text-green-600 text-xl">
                           <?php echo $currencySymbol; ?><?php echo e($paymentAmountDisplay); ?>

                        </span>
                    </p>
                    
                    <?php if(!empty($stripeError)): ?>
                        <div class="bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded mb-4"><?php echo e($stripeError); ?></div>
                    <?php endif; ?>
                    ...
                    <button type="button" id="submit-payment" class="w-full bg-green-600 text-white font-bold py-3 px-4 rounded-lg hover:bg-green-700 transition-colors">
                        Pay <?php echo $currencySymbol; ?><?php echo e($paymentAmountDisplay); ?> Now
                    </button>
                    ...
                    if (submitButton) {
                        ...
                        newButton.addEventListener('click', async (e) => {
                            ...
                            const { error, paymentIntent } = await stripe.confirmPayment({
                                elements,
                                confirmParams: {
                                    return_url: "<?php echo e(url('/payment/success')); ?>", 
                                },
                            ...
                            if (error) {
                                ...
                                window.livewire.find('<?php echo e($_instance->id); ?>').call('handlePaymentSuccess', paymentIntent.id);
                            } else {
                                if (messageContainer) {
...
<?php /**PATH /home/justreused/htdocs/www.justreused.com/resources/views/livewire/create-advertisement.blade.php ENDPATH**/ ?>