...
<script src="<?php echo e(URL::to('js/adminformbuilder/form-builder-cf.min.js')); ?>?rand=<?php echo e($rand); ?>"></script>
<script src="<?php echo e(URL::to('js/jquery.tagsinput-admin.js')); ?>?rand=<?php echo e($rand); ?>"></script>
<link rel="stylesheet" href="<?php echo e(URL::to('css/jquery.tagsinput-admin.css')); ?> " />
...
<script>
    ...
    $('body').on('change', ".ui-sortable-handle .option-logo", function(event) {
        ...
        $.ajax({
            url: '<?php echo e(Url::to("/logo")); ?>', // Point to the server-side PHP script 
            dataType: 'json',
            cache: false,
            processData: false,
            contentType: false,
    ...
    //     url: '<?php echo e(Url::to("/logo")); ?>', // point to server-side PHP script 
...
</style><?php /**PATH /home/justreused/htdocs/www.justreused.com/resources/views/livewire/admin/customfields/js_css.blade.php ENDPATH**/ ?>