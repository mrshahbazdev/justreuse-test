            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2 space-y-8">
                    ...
                    <div class=" rounded-lg shadow-sm border border-gray-200 p-6 flex items-center gap-6">
                        <img src="<?php echo e(\App\Models\TblChat::getPostImgForList($post->id)); ?>" class="h-24 w-24 rounded-lg object-cover border flex-shrink-0">
                        <div>
                            <h2 class="text-xl font-bold text-gray-800"><?php echo e($post->title); ?></h2>
                            <p class="text-lg font-bold text-green-600"><?php echo $currencySymbol; ?><?php echo e(number_format($post->price, 2)); ?></p>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                            <?php $__currentLoopData = $packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pack): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <label wire:key="pack-<?php echo e($pack->id); ?>" class="relative block p-6 border rounded-lg cursor-pointer transition-all <?php echo e($selectedPackageId == $pack->id ? 'bg-green-50 border-green-500 ring-2 ring-green-500' : 'border-gray-200 hover:border-gray-400'); ?>">
                                    <input type="radio" wire:model="selectedPackageId" value="<?php echo e($pack->id); ?>" class="hidden">
                                    <p class="text-lg font-semibold text-gray-800"><?php echo e($pack->name); ?></p>
                                    <p class="text-sm text-gray-500"><?php echo e($pack->duration); ?> Days</p>
                                    <p class="text-2xl font-bold text-green-600 mt-2"><?php echo $currencySymbol; ?><?php echo e(number_format($pack->price, 2)); ?></p>
                                    <?php if($selectedPackageId == $pack->id): ?>
                    ...
                    <div class="sticky top-28 rounded-lg shadow-sm border border-gray-200 p-6">
                        ...
                        <div class="mt-6 pt-6 border-t space-y-2">
                            <div class="flex justify-between items-center text-gray-600">
                                <span>Subtotal</span>
                                <span class="font-semibold"><?php echo $currencySymbol; ?><?php echo e(number_format($packageAmount, 2)); ?></span>
                            </div>
                            <?php if($discountAmount > 0): ?>
                            <div class="flex justify-between items-center text-red-600">
                                <span>Discount</span>
                                <span class="font-semibold">- <?php echo $currencySymbol; ?><?php echo e(number_format($discountAmount, 2)); ?></span>
                            </div>
                            <?php endif; ?>
                             <?php if($taxAmount > 0): ?>
                            <div class="flex justify-between items-center text-gray-600">
                                <span>Tax</span>
                                <span class="font-semibold"><?php echo $currencySymbol; ?><?php echo e(number_format($taxAmount, 2)); ?></span>
                            </div>
                            <?php endif; ?>
...
<?php /**PATH /home/justreused/htdocs/www.justreused.com/resources/views/livewire/select-single-package.blade.php ENDPATH**/ ?>